...
if(isset($_POST["login"])){
  ...
  $query     = 'select * from user where  username ="'.$user.'" AND password="'.$password.'";';
    ...
    //   if($rows = mysqli_num_rows(mysqli_query($conn,$query))){
    //   if($rows>0){
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <!-- <img src="images/icon/logo.png" alt="CoolAdmin"> --><h4> Please Login to Continue</h4>
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <input class="au-btn au-btn--block au-btn--green m-b-20" type="submit" name="login" id="login">
